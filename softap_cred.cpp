...
"  <div id='extra-div' >"
"Use WiSense Dashboard <input type=\"radio\" name=\"answer\" checked=\"checked\" value=\"default\" /> <br>"
"    <form id='extras-2' >"
"      <table width='100%'>"
"       <tr><td><button type='submit' id='save_default' name='save_default' >Save</button> </td></tr>"
"      </table>" 
"    </form>"
"<br> Use Your Own MQTT Credentials <input type=\"radio\" name=\"answer\" value=\"user\" /> <br>"
"<br>"
"    <form id='extras' >"
"      <table width='100%'>"
"        <tr><td><input type='text' id='str1' name='str1' placeholder='MQTT Server' size='35' /></td></tr>"
"        <tr><td><input type='text' id='str2' name='str2' placeholder='MQTT Username' size='35' /></td></tr>"
"        <tr><td><input type='text' id='str3' name='str3' placeholder='MQTT Password' size='35' /></td></tr>"
"        <tr><td><input type='text' id='str4' name='str4' placeholder='MQTT Client ID (Enter NULL, if no)' size='35' /></td></tr>"
"        <tr><td><input type='text' id='str5' name='str5' placeholder='MQTT Topic (Enter NULL, if no)' size='35' /></td></tr>"
"        <tr><td><button type='submit' id='store' name='store' >Store Data</button></td></tr>"
"      </table>" 
"    </form>"
"  </div>"
...
"{"
"    font-weight:bold;"
"    color:#1c75be}.scanning-error{"
"        font-weight:bold;"
"        text-align:center}.radio-div{"
"                                        box-sizing:border-box;"
"                                        margin:2px;"
"                                        margin-left:auto;"
"                                        margin-right:auto;"
...
"                   }"
"                else"
"                b.innerHTML='<p class=\\'scanning-error\\'>No networks found.</p>';"
"                },error:function(a)"
"                {"
...
"    };"
"var configure_callback={success:function(a)"
"    {"
...
"        }"
"    };"
"var connect_callback={success:function(a)"
"    {"
...
"    e.send(d);e.onreadystatechange=function()"
"    {"
"        if(e.readyState==4)"
"        if(c)"
"        {"
